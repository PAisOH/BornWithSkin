...
struct IngredientSheetView: View {
    ...
    private var cosmeticsData: FetchedResults<CosmeticCoreDataModel>
...
//    @State private var scope: CosmeticScope = .name

    @State var cosmetics: [CosmeticCoreDataModel]
                ...
                ZStack(alignment: .top) {
                    ...
                    renderTable()
                        ...
                        .sheet(isPresented: $isPresented) {
                            CosmeticSheetView(isPresented: $isPresented, cosmetic: cosmeticsData[currentSelectionID! - 1])
                        }
                    ...
                    //                            Text("Brand").tag(CosmeticScope.brand)
                    //                            Text("Name").tag(CosmeticScope.name)
                    //                        })
...
//                .width(min: 200, max: 600)
            ...
            TableColumn("Efficacy") { cosmetic in
                //                var itemSubs = item as! CosmeticCoreDataModel
                //                var categories: String = itemSubs.inMoist ?
                //                "Moister" : "1"
                CosmeticFunctionView(cosmetic: cosmetic)
            }
